//NOTE: this file have been modified by HG from ffmpeg source code and released under the same license 
//
...
//////// mod by HG
double ffpmod_s0, ffpmod_s1, ffpmod_s2; 
int ffpmod_min, ffpmod_max;
////////
                           ...
                           int x0, int y0, int log2_cb_size)
{
    ...
    int weight = 1 << (log2_cb_size - lc->ct_depth);
	...
	ffpmod_s0+= weight;
	ffpmod_s1+= weight*lc->qp_y;
	ffpmod_s2+= weight*lc->qp_y*lc->qp_y;
	ffpmod_min= lc->qp_y<ffpmod_min ? lc->qp_y : ffpmod_min;
	ffpmod_max= lc->qp_y>ffpmod_max ? lc->qp_y : ffpmod_max;
	////////
...
static int hevc_frame_end(HEVCContext *s, HEVCLayerContext *l)
{
	...
	//////// mod by HG
	printf("ffprobe_mod: %f %f %f %d %d\n",ffpmod_s0,ffpmod_s1,ffpmod_s2,ffpmod_min,ffpmod_max);
	////////
